...
const services = [
    ...
    { title: 'Invitation Cards', category: 'Personal', description: 'Elegant invitations for every occasion.', image: require('../assets/images/service-invitation.png'), icon: <FaEnvelopeOpenText /> },
    ...
    { title: 'T-shirt Printing', category: 'Custom', description: 'Vibrant custom T-shirt printing for events and promotions.', image: require('../assets/images/service-tshirt.jpeg'), icon: <FaTshirt /> },
    ...
    { title: 'Envelopes', category: 'Business', description: 'Branded envelopes to complement your identity.', image: require('../assets/images/service-envelope.webp'), icon: <FaEnvelopeOpenText /> },
    { title: 'Packaging', category: 'Custom', description: 'Custom packaging solutions for your products.', image: require('../assets/images/service-packaging.png'), icon: <FaPrint /> },
    { title: 'Large Format Printing', category: 'Event', description: 'Eye-catching prints for displays, signage, and exhibitions.', image: require('../assets/images/service-large-format.png'), icon: <MdEventNote /> },
    { title: 'Calendars', category: 'Business', description: 'Personalized calendars for corporate gifting and branding.', image: require('../assets/images/service-calendar.png'), icon: <FaTags /> },
    { title: 'Notebooks', category: 'Business', description: 'Branded notebooks for events, offices, and giveaways.', image: require('../assets/images/service-notebook.webp'), icon: <MdBusinessCenter /> },
    { title: 'Gift Cards', category: 'Personal', description: 'Custom gift cards for promotions and special occasions.', image: require('../assets/images/service-giftcard.jpg'), icon: <FaTags /> },
];
