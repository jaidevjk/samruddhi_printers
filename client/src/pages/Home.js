...
export default function Home() {
    ...
    return (
        <main className="bg-white text-gray-800 home-page">
            ...
            >
                <div className="absolute inset-0 bg-[#143E61] bg-opacity-70"></div>
                <motion.div
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-md leading-tight" style={{ color: '#143E61' }}>
                    ...
                    <a
                        href="/contact"
                        className="bg-[#F57C00] text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-orange-600 transition"
                    >
                        Get a Free Quote
                    </a>
                </motion.div>
